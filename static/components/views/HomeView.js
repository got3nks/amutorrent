  ...
  return h('div', { className: 'py-4 sm:py-8 px-2 sm:px-4' },
    ...
    h('div', { className: 'hidden sm:grid grid-cols-3 gap-3 max-w-4xl mx-auto' },
      ...
      h('button', {
        ...
        className: 'p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition-colors active:scale-95 border border-yellow-200 dark:border-yellow-800'
      },
        h(Icon, { name: 'folder', size: 24, className: 'mx-auto mb-1 text-yellow-600 dark:text-yellow-400' }),
        h('h3', { className: 'font-semibold text-sm text-gray-800 dark:text-gray-200' }, 'Categories')
      ),
      h('button', {
